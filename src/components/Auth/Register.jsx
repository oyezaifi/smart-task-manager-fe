...
function Register() {
    ...
    const onSubmit=async(e)=>{
      ...
      setIsLoading(true);
      try { 
        const response = await api('/api/auth/register',{method:'POST',body:JSON.stringify({email,password,name})}); 
        ...
        const errorMessage = e.data?.message || 'Registration failed';
        setErr(errorMessage);
      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-900 via-slate-800 to-blue-900 flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-300">Start organizing your work today</p>
          </div>
